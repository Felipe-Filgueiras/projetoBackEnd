...
A MollDelivery atende a consumidores de todas as idades e perfis que buscam conveniência e rapidez nas compras online. O mercado-alvo inclui pessoas que preferem comprar de lojas físicas locais, mas desejam a comodidade das compras online.

3.2 Resumo da Parte Interessada:

Consumidores: Representa os indivíduos que utilizam a plataforma para fazer compras online.
Comerciantes Locais: Representa as lojas físicas locais que disponibilizam seus produtos na plataforma.
Investidores: Representa os financiadores e stakeholders interessados no sucesso da MollDelivery.
3.3 Resumo do Usuário:

Consumidores: São os usuários finais que utilizam a plataforma para fazer compras online.
Comerciantes Locais: São os usuários que cadastram e gerenciam seus produtos na plataforma.

3.4 Ambiente do Usuário:
Os usuários alvo da MollDelivery são aqueles que têm acesso à internet e dispositivos conectados, como smartphones, tablets ou computadores. Eles podem estar em casa, no trabalho ou em trânsito.
...
|--------------------|---------------|-----------|------|---------------------|----------------------|--------------|----------|-------------------------|
| Consumidores | - | Indivíduos que utilizam a plataforma para fazer compras online. | Usuários finais | - Utilizar a plataforma para realizar compras de forma conveniente. - Proporcionar feedback sobre a experiência de uso da plataforma. | - Facilidade de navegação e compra na plataforma. - Variedade e qualidade dos produtos disponíveis. - Tempo de entrega satisfatório. | Testes de usabilidade, feedback sobre a experiência de compra. | Feedback sobre a experiência de compra. | Questões de segurança de dados. |
| Comerciantes Locais | Representantes de cada estabelecimento | Estabelecimentos físicos que disponibilizam seus produtos na plataforma. | Especialistas de negócios | - Cadastrar e gerenciar produtos na plataforma. - Manter estoque atualizado. - Atender às demandas dos clientes. | - Aumento das vendas por meio da plataforma. - Satisfação dos clientes com os produtos e serviços oferecidos. | Cadastro e atualização de produtos, atendimento ao cliente. | Produtos cadastrados e atualizados, feedback dos clientes. | Dificuldades técnicas na integração com a plataforma. |
| Investidores | - | Financiadores e stakeholders interessados no sucesso da MollDelivery. | Stakeholders | - Investir recursos financeiros no desenvolvimento e operação da plataforma. - Acompanhar o desempenho e retorno do investimento. | - Retorno financeiro positivo sobre o investimento. - Crescimento e expansão da base de usuários e comerciantes. | Monitoramento do desempenho financeiro, análise de métricas de negócio. | Relatórios financeiros, análises de métricas de negócio. | Riscos financeiros e estratégicos. |
...
|----------|---------------|-----------|------|-------------------|----------------------|--------------|----------|-------------------------|
| Consumidor | Representante dos Consumidores | Indivíduos que utilizam a plataforma para fazer compras online. | Usuários finais | - Navegar pela plataforma. - Selecionar e comprar produtos. - Avaliar a experiência de compra. | - Facilidade de uso da plataforma. - Variedade e qualidade dos produtos disponíveis. - Tempo de entrega satisfatório. | Testes de usabilidade, feedback sobre a experiência de compra. | Feedback sobre a experiência de compra. | Questões de segurança de dados. |
| Comerciante Local | Representante dos Comerciantes Locais | Proprietários ou funcionários de estabelecimentos físicos que disponibilizam seus produtos na plataforma. | Especialistas de negócios | - Cadastrar produtos na plataforma. - Gerenciar estoque e pedidos. - Atender às demandas dos clientes. | - Aumento das vendas por meio da plataforma. - Satisfação dos clientes com os produtos e serviços oferecidos. | Cadastro e atualização de produtos, atendimento ao cliente. | Produtos cadastrados e atualizados, feedback dos clientes. | Dificuldades técnicas na integração com a plataforma. |

3.7 Principais Necessidades da Parte Interessada ou do Usuário:

| Necessidade | Prioridade | Interesses | Solução Atual | Solução Proposta |
|-------------|------------|------------|---------------|-----------------|
| Variedade e Qualidade de Produtos Disponíveis | Alta | Consumidores e Comerciantes Locais | Limitada seleção de produtos de lojas físicas locais. | Plataforma online que conecta consumidores a uma ampla variedade de produtos de lojas físicas locais. |
| Facilidade de Uso da Plataforma | Alta | Consumidores e Comerciantes Locais | Interfaces complexas e pouco intuitivas. | Interface intuitiva e amigável, com processo de compra simplificado. |
| Tempo de Entrega Satisfatório | Alta | Consumidores | Longos prazos de entrega. | Sistema eficiente de logística para entrega rápida dos produtos. |

3.8 Alternativas e Concorrência:

| Alternativas e Concorrência | Principais Pontos Fortes | Principais Pontos Fracos |
|-----------------------------|-------------------------|-------------------------|
| Plataformas de e-commerce convencionais (ex: Amazon, Mercado Livre) | - Grande variedade de produtos. - Logística de entrega eficiente. - Reconhecimento da marca. | - Distância entre consumidores e comerciantes. - Dificuldade de competir com grandes empresas consolidadas. |
| Outras plataformas de delivery de produtos locais | - Foco em produtos de lojas físicas locais. - Potencial para estabelecer parcerias com pequenos comerciantes. | - Limitada variedade de produtos. - Desafios na logística de entrega. - Pouca visibilidade em comparação com grandes players do mercado. |
